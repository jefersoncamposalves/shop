...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
      String email, String password, String urlFragmented) async {
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlFragmented?key=AIzaSyAr9c7aEQUdghifXlgN0qbCz1L0b0RLExk';
